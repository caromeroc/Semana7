...
public class VentanaUno extends javax.swing.JFrame {
    ...
    PanelUno objPanelUno = new PanelUno();
    PanelDos objPanelDos = new PanelDos();
    
    public VentanaUno() {
        initComponents();
      
        objPanelDos.setBounds(50, 100, 600, 300);
        this.add(objPanelDos);
        objPanelDos.setVisible(Boolean.TRUE);       
        this.validate();
        this.repaint();
    }
